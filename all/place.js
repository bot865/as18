...
Skyzo.inspectLink = async (code) => {
        ...
        const metadata = {
        id: groupId,
        subject: group.attrs.subject || "𝐍𝐮𝐥𝐥",
        creator: group.attrs.creator || "𝐍𝐨𝐭 𝐝𝐞𝐭𝐞𝐜𝐭𝐞𝐝",
        creation: group.attrs.creation || "𝐍𝐨𝐭 𝐝𝐞𝐭𝐞𝐜𝐭𝐞𝐝",
        desc,
        descId,
        };
        return metadata;
...
exports.logic = (check, inp, out) => {
    if (inp.length !== out.length) throw new Error('Input dan Output harus memiliki panjang yang sama')
